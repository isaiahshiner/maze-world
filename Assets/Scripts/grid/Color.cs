namespace MazeWorld
{
    public class Color {
        ...
        public readonly static Color Brown = new Color(139, 69, 19);
        
        public readonly static Color DarkGray = new Color(64, 64, 64);
        public readonly static Color DarkGrey = new Color(64, 64, 64);
        ...
        public readonly static Color LightGrey = new Color(192, 192, 192);
